...
public class Baseball_America_2017_Midseason_Parser extends Parser{

	private static final Logger log = LoggerFactory.getLogger(PlayerSearcher.class);

	
	public Baseball_America_2017_Midseason_Parser() {
	}

	public Baseball_America_2017_Midseason_Parser(String file){
		super(file);
	}
